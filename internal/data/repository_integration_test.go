...
func TestIntegration_RouteRunLifecycle(t *testing.T) {
	...
	for _, cp := range checkpoints {
		if err := repo.RecordCheckpoint(run.ID, cp.id, cp.name, cp.igtMs, cp.durationMs, 0); err != nil {
...
func TestIntegration_MultipleRunsPBTracking(t *testing.T) {
	...
	if err := repo.RecordCheckpoint(run1.ID, "boss1", "Iudex Gundyr", 100000, 100000, 0); err != nil {
		t.Fatalf("RecordCheckpoint: %v", err)
	}
	if err := repo.RecordCheckpoint(run1.ID, "boss2", "Vordt", 250000, 150000, 0); err != nil {
		t.Fatalf("RecordCheckpoint: %v", err)
	}
	...
	if err := repo.RecordCheckpoint(run2.ID, "boss1", "Iudex Gundyr", 85000, 85000, 0); err != nil {
		t.Fatalf("RecordCheckpoint: %v", err)
	}
	if err := repo.RecordCheckpoint(run2.ID, "boss2", "Vordt", 260000, 175000, 0); err != nil {
		t.Fatalf("RecordCheckpoint: %v", err)
	}
...
func TestIntegration_SaveChangeMidRun(t *testing.T) {
	...
	if err := repo.RecordCheckpoint(runA.ID, "boss1", "Iudex Gundyr", 95000, 95000, 0); err != nil {
		t.Fatalf("RecordCheckpoint: %v", err)
	}
...
func TestIntegration_RunResumeAfterRestart(t *testing.T) {
	...
	if err := repo1.RecordCheckpoint(run.ID, "boss1", "Iudex Gundyr", 95000, 95000, 0); err != nil {
		t.Fatalf("RecordCheckpoint: %v", err)
	}
	...
	// Continue the run
	if err = repo2.RecordCheckpoint(found.ID, "boss2", "Vordt", 225000, 130000, 0); err != nil {
		t.Fatalf("RecordCheckpoint: %v", err)
	}
