...
// Returns nil on success (same save or first detection),
...
// or a wrapped error for read failures.
func (b *baseTracker) detectSave(reader *memreader.GameReader) error {
