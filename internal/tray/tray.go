...
func getIcon() []byte {
	// Simple red square as placeholder icon
	...
	return []byte{
		...
		0x54, 0x28, 0x91, 0x63, 0xFC, 0xCF, 0xC0, 0xC0,
		0xC0, 0xC0, 0xC0, 0xC0, 0xC0, 0x00, 0x00, 0x00,
		0x00, 0xFF, 0xFF, 0x03, 0x00, 0x00, 0x1F, 0x00,
		0x01, 0xE8, 0x8C, 0xA3, 0x1A, 0x00, 0x00, 0x00,
